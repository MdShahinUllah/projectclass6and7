    ...
    <nav class="navigation">
        <div class="container-fluid">
            ...
            <div class="navigation__column right">
                ...
                <div class="ps-cart"><a class="ps-cart__toggle" href="#"><span><i>{{$totalQty}}</i></span><i class="ps-icon-shopping-cart"></i></a>
                    <div class="ps-cart__listing">
                        ...
                        @foreach($carts as $cart)
                                <div class="ps-cart-item">
                                    ...
                                    <div class="ps-cart-item__thumbnail">
                                        <a href="product-detail.html"></a><img src="@if(!filter_var($cart['photo'], FILTER_VALIDATE_URL)) {{asset('uploads/'.$cart['photo'])}}@else{{$cart['photo']}} @endif" alt="">
                                    </div>

                                    <div class="ps-cart-item__content">
                                        <a class="ps-cart-item__title" href="product-detail.html">{{$cart['title']}}</a>
                                        <p>
                                            <span>Quantity:<i>{{$cart['quantity']}}</i></span>
                                            <span>Total:<i>{{$cart['quantity']* $cart['price']}}</i></span>
                                        </p>
                                    </div>
                                </div>
                        @endforeach
                        ...
                        <div class="ps-cart__total">
                            <p>Number of items:<span>{{$totalQty}}</span></p>
