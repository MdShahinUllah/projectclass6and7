                        ...
                        <div class="ps-product__thumbnail">
                            <div class="ps-product__preview">
                                <div class="ps-product__variants">
                                    <div class="item"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></div>
                                    <div class="item"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></div>
                                    <div class="item"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></div>
                                    <div class="item"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></div>
                                    <div class="item"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></div>
                                </div><a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""><i class="fa fa-play"></i></a>
                            </div>
                            <div class="ps-product__image">
                                <div class="item"><img class="zoom" src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt="" data-zoom-image="images/shoe-detail/1.jpg"></div>
                                <div class="item"><img class="zoom" src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt="" data-zoom-image="images/shoe-detail/2.jpg"></div>
                                <div class="item"><img class="zoom" src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt="" data-zoom-image="images/shoe-detail/3.jpg"></div>
                            </div>
                        </div>
                        <div class="ps-product__thumbnail--mobile">
                            <div class="ps-product__main-img"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></div>
...
{{--                            </div>--}}
                            ...
                            <h3 class="ps-product__price">£ 115 <del>{{$product->price}}</del></h3>
                            ...
                            <div class="ps-product__block ps-product__style">
                                ...
                                <ul>
                                    <li><a href="product-detail.html"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></a></li>
                                    <li><a href="product-detail.html"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></a></li>
                                    <li><a href="product-detail.html"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></a></li>
                                    <li><a href="product-detail.html"><img src="@if(!filter_var($product->photo, FILTER_VALIDATE_URL)) {{asset('uploads/'.$product->photo)}}@else{{$product->photo}} @endif" alt=""></a></li>
                                </ul>
