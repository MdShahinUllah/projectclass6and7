...
@section('home')
    <main class="ps-main">
            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              <div class="ps-product__thumbnail">
                ...
                <div class="ps-product__image">
                  <div class="item"><img class="zoom" src="{{asset('assets/images/shoe-detail/1.jpg')}}" alt="" data-zoom-image="{{asset('assets/images/shoe-detail/1.jpg')}}"></div>
                  <div class="item"><img class="zoom" src="{{asset('assets/images/shoe-detail/2.jpg')}}" alt="" data-zoom-image="{{asset('assets/images/shoe-detail/2.jpg')}}"></div>
                  <div class="item"><img class="zoom" src="{{asset('assets/images/shoe-detail/3.jpg')}}" alt="" data-zoom-image="{{asset('assets/images/shoe-detail/3.jpg')}}"></div>
                </div>
              </div>
              ...
              <div class="ps-product__info">
                ...
                <div class="ps-product__block ps-product__style">
                  ...
                  <ul>
                    <li><a href="{{route('productDetail')}}"><img src="{{asset('assets/images/shoe/sidebar/1.jpeg')}}" alt=""></a></li>
                    <li><a href="{{route('productDetail')}}"><img src="{{asset('assets/images/shoe/sidebar/2.jpeg')}}" alt=""></a></li>
                    <li><a href="{{route('productDetail')}}"><img src="{{asset('assets/images/shoe/sidebar/3.jpeg')}}" alt=""></a></li>
                    <li><a href="{{route('productDetail')}}"><img src="{{asset('assets/images/shoe/sidebar/4.jpeg')}}" alt=""></a></li>
                  </ul>
                </div>
              ...
              <div class="tab-content mb-60">
                ...
                <div class="tab-pane" role="tabpanel" id="tab_02">
                  ...
                  <div class="ps-review">
                    <div class="ps-review__thumbnail"><img src="{{asset('assets/images/user/1.jpg')}}" alt=""></div>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/images/shoe/1.jpg')}}" alt=""><a class="ps-shoe__overlay" href="{{route('productDetail')}}"></a>
                  </div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    ...
                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/images/shoe/2.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.blade.php"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/5.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/images/shoe/3.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.blade.php"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/5.jpg')}}" alt=""></div>
                      <select class="ps-rating ps-shoe__rating">
                        ...
                        <option value="1">2</option>
                        <option value="1">3</option>
                        <option value="1">4</option>{asset{(assets/'}}
                        <option value="2">5</option>
                      </select>
                    </div>
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.html">Air Jordan 7 Retro</a>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/images/shoe/4.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.blade.php"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/5.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/images/shoe/5.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.blade.php"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/5.jpg')}}" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{asset('assets/images/shoe/6.jpg')}}" alt=""><a class="ps-shoe__overlay" href="product-detail.blade.php"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{asset('assets/images/shoe/2.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/3.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/4.jpg')}}" alt=""><img src="{{asset('assets/images/shoe/5.jpg')}}" alt=""></div>
      ...
      <div class="ps-footer bg--cover" data-background="{{asset('assets/images/background/parallax.jpg')}}">
