                            ...
                            <div class="e-profile">
                                ...
                                <div class="tab-content pt-3">
                                    <div class="tab-pane active">
                                        <form class="form" novalidate="" method="post" action="{{route('admin.profile')}}">
                                            @csrf
                                            <div class="row">
                                                <div class="col">
                                                    <div class="row">
...
{{--                                                                <input class="form-control" type="text" name="id" placeholder="johnny.s" value="{{auth()->user()->id}}">--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input class="form-control" type="email" placeholder="user@example.com" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
